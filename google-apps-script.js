...
function doPost(e) {
  try {
    ...
    const resultado = saveToSheet(nombre, dormir, alergia, diet, imagenUrl);
 ...
 */
function saveToSheet(nombre, dormir, alergia, diet, imagenUrl) {
  try {
...
function uploadImageToDrive(imageData, nombrePersona) {
  try {
    ...
    console.log("Imagen subida a Drive:", file.getUrl());
...
function testFunction() {
  ...
  try {
    ...
    console.log("Conexión a Sheets exitosa:", sheet.getName());
  } catch (error) {
  ...
  try {
    const folder = DriveApp.getFolderById(DRIVE_FOLDER_ID);
    console.log("Conexión a Drive exitosa:", folder.getName());
  } catch (error) {
 ...
 */
function testDoPost() {
  console.log("Simulando petición POST...");
  ...
  try {
    ...
    console.log("Test exitoso:", result.getContent());
  } catch (error) {
...
function testImageUpload() {
  console.log("=== TEST DE SUBIDA DE IMAGEN ===");
  ...
  try {
    ...
    console.log("✅ Test de imagen exitoso:", result);
    return result;
  } catch (error) {
...
function testDrivePermissions() {
  console.log("=== TEST DE PERMISOS DE DRIVE ===");

  try {
    const folder = DriveApp.getFolderById(DRIVE_FOLDER_ID);
    console.log("✅ Carpeta accesible:", folder.getName());
    console.log("URL de la carpeta:", folder.getUrl());
